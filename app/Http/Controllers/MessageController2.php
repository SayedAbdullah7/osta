...
use App\Services\ChatifyMessenger as Chatify;
...
class MessageController2 extends Controller
{
    ...
    {
        $chatifyMessenger = new \App\Services\ChatifyMessenger();
        $fallbackColor = $chatifyMessenger->getFallbackColor();
        $messenger_color = Auth::user()->messenger_color;
        return view('Chatify::pages.app', [
            'id' => $id ?? 0,
//            'messengerColor' => $messenger_color ? $messenger_color : Chatify::getFallbackColor(),
            'messengerColor' => $messenger_color ? $messenger_color : $fallbackColor,
